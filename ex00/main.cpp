...
int main(int ac, char **av) {
    try {
        ...
        log.info() << "Insertion operator (<<) overload result: " << john << std::endl;
        ...
        log.info() << "Insertion operator (<<) overload result: " << jane << std::endl;
        ...
        try {
            ...
            log.info() << "Insertion operator (<<) overload result: " << failure << std::endl;
        } catch (const Bureaucrat::GradeTooHighException &gradeTooHigh) {
